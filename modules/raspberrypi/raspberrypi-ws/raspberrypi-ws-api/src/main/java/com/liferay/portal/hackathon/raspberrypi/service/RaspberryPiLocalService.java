...
/**
 * Provides the local service interface for RaspberryPi. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RaspberryPiLocalServiceUtil
...
public interface RaspberryPiLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RaspberryPiLocalServiceUtil} to access the raspberry pi local service. Add custom service methods to {@link com.liferay.portal.hackathon.raspberrypi.service.impl.RaspberryPiLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public RaspberryPi addRaspberryPi(RaspberryPi raspberryPi);
	...
	*/
	public RaspberryPi createRaspberryPi(long raspberryId);
	...
	*/
	...
	public RaspberryPi deleteRaspberryPi(RaspberryPi raspberryPi);
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public RaspberryPi deleteRaspberryPi(long raspberryId)
		throws PortalException;

	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RaspberryPi fetchRaspberryPi(long raspberryId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public RaspberryPi getRaspberryPi(long raspberryId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public RaspberryPi updateRaspberryPi(RaspberryPi raspberryPi);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<RaspberryPi> getRaspberryPis(int start, int end);
